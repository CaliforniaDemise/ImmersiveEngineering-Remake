package surreal.bpcatacombs.inventory.gui;

import surreal.bpcatacombs.Tags;
import surreal.bpcatacombs.inventory.container.ContainerWorkbench;
...
public class GuiWorkbench extends GuiContainer {
    ...
    protected static final ResourceLocation WORKBENCH_GUI = new ResourceLocation(Tags.MOD_ID, "textures/gui/workbench.json.png");
