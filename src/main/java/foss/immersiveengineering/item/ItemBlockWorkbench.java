...
import foss.immersiveengineering.block.BlockWorkbench;
...
public class ItemBlockWorkbench extends ItemBlock {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        System.out.println("mainFacing: " + mainFacing.getName() + "    slaveFacing: " + slaveFacing.getName());
        ...
        if (!slaveState.getBlock().isReplaceable(worldIn, slavePos)) {
            System.out.println("changing slavePos and pos");
