package foss.immersiveengineering.client.resource;
...
//        map.putTex("item/material_wire_steel"); Not a proper PNG
        ...
        map.putTex("item/metal_ingot_gold");
        map.putTex("item/metal_ingot_iron");
        ...
        map.putTex("item/metal_nugget_gold");
        map.putTex("item/metal_nugget_iron");
